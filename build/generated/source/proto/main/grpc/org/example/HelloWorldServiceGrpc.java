...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.Hello.HelloRequest,
      org.example.Hello.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = org.example.Hello.HelloRequest.class,
      responseType = org.example.Hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.Hello.HelloRequest,
      org.example.Hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<org.example.Hello.HelloRequest, org.example.Hello.HelloResponse> getHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloMethod = HelloWorldServiceGrpc.getHelloMethod) == null) {
          HelloWorldServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<org.example.Hello.HelloRequest, org.example.Hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.Hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.Hello.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(org.example.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<org.example.Hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void hello(org.example.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<org.example.Hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public org.example.Hello.HelloResponse hello(org.example.Hello.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.Hello.HelloResponse> hello(
        org.example.Hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((org.example.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<org.example.Hello.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              org.example.Hello.HelloRequest,
              org.example.Hello.HelloResponse>(
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.Hello.getDescriptor();
    }
